...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bInit.setMinimumSize(QSize(0, 0))
        font = QFont()
        font.setBold(False)
        ...
        self.bReset.setMinimumSize(QSize(0, 0))
        ...
        self.bSave.setMinimumSize(QSize(0, 0))
        ...
        self.bConfig.setMinimumSize(QSize(0, 0))
        ...
        self.labelpeso.setMinimumSize(QSize(100, 0))
        font1 = QFont()
        font1.setPointSize(10)
        font1.setBold(False)
        self.labelpeso.setFont(font1)
        self.labelpeso.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.labelpeso.setFrameShape(QFrame.Box)
        self.labelpeso.setLineWidth(1)
        ...
        self.labeltempo.setMinimumSize(QSize(100, 0))
        self.labeltempo.setFont(font1)
        self.labeltempo.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.labeltempo.setFrameShape(QFrame.Box)
        self.labeltempo.setLineWidth(1)
